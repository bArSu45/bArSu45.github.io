...
export default function Footer({ colorMode }) {
    return (
        <Box id={style.footer_mainDiv}>
            <Box id={style.footer_mainDiv1} color={colorMode === 'light' ? "#4C3575" : '#BFACE0'}>
            ...
            <Box id={style.footer_mainDiv2} backgroundColor={colorMode === 'light' ? "#4C3575" : '#BFACE0'}>
                <Box id={style.footer_aDiv}>
                    <a href='https://twitter.com/OjhaBarsarani' target='_blank' rel="noreferrer"><FaTwitter color='white'/></a>
            ...
            <Box id={style.footer_mainDiv3} backgroundColor={colorMode === 'light' ? "#4C3575" : '#BFACE0'}><p>Created By Barsa Rani Ojha | © 2022. All Rights Reserved</p></Box>
        </Box>
    )
}
