...
export default function MiniProject({ colorMode }) {
    ...
    return (
        <div id={style.majorMain}>
            <Heading color={colorMode === 'light' ? "#4C3575" : '#BFACE0'} size={['lg', 'lg', 'lg', '2xl']} textDecoration='underline'>Minor Projects</Heading>
            <div data-aos="fade-up"
                ...
                <Box className={style.major_project_detailsDiv} color={colorMode === 'light' ? "#4C3575" : '#371B58'}>
                    ...
                    <Box className={style.major_project_detailsDi_btnDiv}>
                        ...
                        <Button size={['xs', 'sm', 'sm', 'md']} ><a className={style.links} rel="noreferrer" href="https://fancy-trifle-62f26d.netlify.app/" target="_blank">Live </a> &nbsp;< FaArrowRight /> </Button>
                    </Box>
                </Box>
            </div>
            ...
            <div data-aos="fade-up"
                ...
                <Box className={style.major_project_detailsDiv} color={colorMode === 'light' ? "#4C3575" : '#371B58'}>
                    ...
                    <Box className={style.major_project_detailsDi_btnDiv}>
                        <Button size={['xs', 'sm', 'sm', 'md']}><a className={style.links} rel="noreferrer" href="https://github.com/bArSu45/Super-Sale" target="_blank">Source Code </a> &nbsp;< FaGithub /> </Button>
                        <Button size={['xs', 'sm', 'sm', 'md']}><a className={style.links} rel="noreferrer" href="https://strong-kheer-cad87d.netlify.app/" target="_blank">Live </a> &nbsp;< FaArrowRight /> </Button>
                    </Box>
                </Box>
                <Box className={style.major_project_imgDiv}>
            ...
            <div data-aos="fade-up"
                ...
                <Box className={style.major_project_detailsDiv} color={colorMode === 'light' ? "#4C3575" : '#371B58'}>
                    ...
                    <Heading className={style.major_project_detailsDiv_tehcs} size={['sm', 'sm', 'sm', 'md']}>Tech Stack: HTML | CSS | JavaScript</Heading>
                    <Box className={style.major_project_detailsDi_btnDiv}>
                        <Button size={['xs', 'sm', 'sm', 'md']} ><a className={style.links} rel="noreferrer" href="https://github.com/bArSu45/Job_App" target="_blank">Source Code </a> &nbsp;< FaGithub /> </Button>
                        <Button size={['xs', 'sm', 'sm', 'md']} ><a className={style.links} rel="noreferrer" href="https://cozy-beignet-e98b40.netlify.app/" target="_blank">Live </a> &nbsp;< FaArrowRight /> </Button>
                    </Box>
                </Box>
            </div>
        </div>
